...
@section('conteudo')
    ...
    <form class="row g-4" method="POST" action="{{ route('vendas.store') }}">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control form-control-lg bg-light" id="formaPagamentoVenda" name="formapagamento" required>
        ...
        <div class="col-md-4">
            ...
            <select class="form-control form-control-lg bg-light" id="idComprador" name="comprador" required>
